...
import {LOGIN, LOGIN_FAILURE, LOGIN_SUCCESS, LOGOUT, SIGNUP, SIGNUP_SUCCESS} from "../../actionTypes";
...
export type AuthActions = ReturnType<Login | Logout | SignUp | LoginSuccess | SignUpSuccess | LoginFailure>